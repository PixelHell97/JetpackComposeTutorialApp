package com.pixel.jetpackcomposetutorialapp.highlightor.scopes
...
import com.pixel.jetpackcomposetutorialapp.highlightor.model.HighlightorTarget
...
class HighlightorScope(
    ...
    internal fun HighlightorBox(
        ...
        currentTarget?.let { highlightorContent ->
            ...
            val xContent =
                remember(highlightorContent) {
                    highlightorContent.coordinates
                        .positionInRoot()
                        .x
                        .toInt()
                }
    ...
    private fun Modifier.highlightorTarget(
        ...
        onGloballyPositioned { coordinates ->
            state.highlightorTargets[index] =
                HighlightorTarget(
                    index = index,
